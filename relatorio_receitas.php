...
// ATENÇÃO: Substitua este caminho pelo caminho absoluto ou correto no seu servidor
...
$html = "
    <style>
        ...
        .header h2 { text-align: center; color: #007BFF; font-size: 20px; margin: 0; }
...
// Cria a nova estrutura do cabeçalho com logo e título usando Flexbox e a imagem Base64
$html .= "<div class='header'>
            <img src='{$logoSrc}' width='80' height='40' />
            <h2>Relatório de Recebimentos - {$mesNome}/{$ano}</h2>
          </div>";
