...
<html lang="pt-br">
<head>
    <title>Consulta de Formas de Rec/Pag</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="card">
            ...
            <div class="search-box">
                <form method="post" action="index.php" class="row g-3 align-items-center">
                    <div class="col-md-8">
                        <input type="text" name="desc_forma" class="form-control" 
                               placeholder="Pesquisar formas de recebimento/pagamento...">
                    </div>
                    <div class="col-md-4">
                        <button type="submit" name="consultar_forma" class="btn btn-pesquisar w-100">
            ...
            <div class="table-responsive">
                ...
                <table id="listar-forma" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th class="text-center">Código</th>
                            <th class="text-center">Forma Rec/Pag</th>
                            <th class="text-center">Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach($resultado as $forma): ?>
                        <tr>
                            <td class="text-center"><?= $forma->id_cad_forma ?></td>
                            <td class="text-center"><?= $forma->desc_forma ?></td>
                            <td class="text-center">
                                <button type="button" class="btn btn-outline-primary btn-action" 
                                        data-bs-toggle="modal" 
                                        data-bs-target="#alterar_forma<?= $forma->id_cad_forma ?>">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                <button type="button" class="btn btn-outline-danger btn-action" 
                                        data-bs-toggle="modal" 
                                        data-bs-target="#excluir_forma<?= $forma->id_cad_forma ?>">
                                    <i class="bi bi-trash"></i>
                                </button>
                            </td>
                        </tr>
                        <?php 
                            $this->modal_alterar_forma($forma->id_cad_forma, $forma->desc_forma);
                            $this->modal_excluir_forma($forma->id_cad_forma, $forma->desc_forma);
                        ?>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#listar-forma').DataTable({
