            ...
            <div class="card">
                ...
                <form method="post" action="index.php">
                    <div class="form-content">
                        <h5 class="section-title">Informações do Plano de Contas</h5>
                        
                        <div class="mb-3">
                            <label class="form-label">Descrição do Plano</label>
                            <input type="text" required name="desc_plano" class="form-control" 
                        ...
                        <div class="text-center mt-4">
                            ...
                            <button type="submit" name="inserir_plano" class="btn btn-save btn-action">
